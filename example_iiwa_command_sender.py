# BE EXTREMELY CAREFUL WHEN RUNNING THIS CODE
# IT MOVES ALL JOINT TO 0 POSITION INSTANTANEOUSLY
# SO, RUN IT ONLY WHEN ALL THE JOINTS ARE NEAR 0 POSITIONS
...
robot_command_publisher = builder.AddSystem(LcmPublisherSystem.Make(
